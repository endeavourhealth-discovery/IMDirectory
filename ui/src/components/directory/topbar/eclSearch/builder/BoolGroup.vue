<template>
  <div :class="[hover ? 'nested-div-hover' : 'nested-div']" @mouseover="mouseover" @mouseout="mouseout">
    ...
    <template v-for="(item, index) in value.items">
      <div class="component-container">
        <span class="left-container">
          ...
          <Button v-else-if="index > 1" type="button" :label="value.conjunction" severity="secondary" disabled />
        </span>
    ...
    <div class="add-group">
      <Button type="button" :severity="hover && 'success'" :class="!hover && 'p-button-placeholder'" label="Add Concept" @click="addConcept" />
      <Button type="button" :severity="hover && 'success'" :class="!hover && 'p-button-placeholder'" label="Add Refinement" @click="addRefinement" />
      <Button type="button" :severity="hover && 'success'" :class="!hover && 'p-button-placeholder'" label="Add New Group" @click="addGroup" />
      <Button
        type="button"
