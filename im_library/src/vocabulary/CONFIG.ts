export class CONFIG {
  ...
  // github release
  public static IMDIRECTORY_LATEST_RELEASE = CONFIG.NAMESPACE + "IMDirectoryLatestRelease";
  public static IMDIRECTORY_ALL_RELEASES = CONFIG.NAMESPACE + "IMDirectoryAllReleases";
  public static IMPORT_DATA_LATEST_RELEASE = CONFIG.NAMESPACE + "ImportDataLatestRelease";
  public static IMPORT_DATA_ALL_RELEASES = CONFIG.NAMESPACE + "ImportDataAllReleases";
}
