...
describe("EntityService.ts ___ axios success", () => {
  ...
  it("can get partial entity", async () => {
    ...
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/partial", { params: { iri: "testIri", predicates: "pred_1,pred_2,pred_3" } });
  ...
  it("can get entity parents", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/parents", { params: { iri: "testIri" } });
    expect(result).toBe("axios get return");
  });
  ...
  it("can get entity children", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/children", { params: { iri: "testIri" }, signal: controller.signal });
    expect(result).toBe("axios get return");
  });
  ...
  it("can get entity usages", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/usages", { params: { iri: "testIri", page: 1, size: 25 } });
    expect(result).toBe("axios get return");
  });
  ...
  it("can get usages total records", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/usagesTotalRecords", { params: { iri: "testIri" } });
    expect(result).toBe("axios get return");
  });
  ...
  it("can get entity graph", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/graph", { params: { iri: "testIri" } });
    expect(result).toBe("axios get return");
  });
  ...
  it("can get entity term codes", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/concept/private/termCode", { params: { iri: "testIri" } });
    expect(result).toBe("axios get return");
  });
  ...
  it("can get partial bundle", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/partialBundle", {
  ...
  it("can get entity summary", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/entity/private/summary", { params: { iri: "testIri" } });
    expect(result).toBe("axios get return");
  });
  ...
  it("can getMatchedFrom", async () => {
    ...
    expect(axios.get).toHaveBeenCalledTimes(1);
    expect(axios.get).toHaveBeenCalledWith(api + "api/concept/private/matchedFrom", { params: { iri: "testString" } });
    expect(result).toBe("axios get return");
  });
});
