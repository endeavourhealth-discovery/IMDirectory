...
import { onUnmounted, onBeforeUnmount, onMounted, computed, ref, Ref, watch, defineComponent, PropType, provide, nextTick, ComputedRef } from "vue";
...
import { DataTypeCheckers, Converters } from "@im-library/helpers";
...
const { editorEntity, editorEntityOriginal, fetchEntity, processEntity } = setupEntity();
const { shape, stepsItems, getShape, getShapesCombined, groups, processComponentType, processShape, addToShape } = setupShape();
