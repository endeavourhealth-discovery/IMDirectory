...
export default class ConfigController {
  ...
  private initRoutes() {
    this.router.get("/public/componentLayout", async (req, res, next) => await this.getComponentLayout(req, res, next));
    this.router.get("/public/dashboardLayout", async (req, res, next) => await this.getDashboardLayout(req, res, next));
  }
