...
<template>
  <tr>
    <td v-if="viewerProps.lineNumbers" :class="`line-${l.type} line-number`" :style="{ backgroundColor: bgLeft }">
      {{ l.lineNumber }}
    </td>
    ...
    <td v-if="viewerProps.lineNumbers" :class="`line-${r.type} line-number`" :style="{ backgroundColor: bgRight }">
      {{ r.lineNumber }}
    </td>
