  ...
  >
    ...
    <Column :exportable="false" bodyStyle="text-align: center; overflow: visible; justify-content: flex-end;">
      <template #body="{data}">
        ...
        />
        <Button icon="pi pi-fw pi-eye" class="p-button-rounded p-button-text p-button-plain" @click="view(data['@id'])" />
        <Button icon="pi pi-fw pi-info-circle" class="p-button-rounded p-button-text p-button-plain" @click="showInfo(data['@id'])" />
        ...
        <Button v-else icon="pi pi-fw pi-star" class="p-button-rounded p-button-text p-button-plain" @click="updateFavourites(data['@id'])" />
      </template>
    </Column>
  </DataTable>
