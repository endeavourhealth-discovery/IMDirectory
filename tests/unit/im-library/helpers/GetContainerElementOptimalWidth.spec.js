import { getContainerElementOptimalWidth } from "@/helpers/modules/ContainerDimensionGetters";
...
describe("GetContainerElementOptimalWidth", () => {
  ...
  beforeEach(() => {
    ...
    mockElement.getBoundingClientRect = vi
      .fn()
  ...
  it("gets width ___ no container", () => {
    expect(
      getContainerElementOptimalWidth(
        "container-id",
        ["element-1-class", "element-2-class"],
        false
      )
    ).toBe("");
  });
