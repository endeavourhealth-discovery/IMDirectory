...
import { FormGenerator, PropertyGroup, PropertyShape, QueryRequest, TTIriRef } from "@/im_library/interfaces";
...
import { ConceptTypeMethods, DataTypeCheckers, EntityValidator, Converters } from "@/im_library/helpers";
...
const { hasValidIri, hasValidName, hasValidParents, hasValidStatus, hasValidTypes } = EntityValidator;
