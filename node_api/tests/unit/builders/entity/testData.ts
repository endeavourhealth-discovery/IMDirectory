  ...
  entityBundle: {
    entity: {
      ...
      "http://endhealth.info/im#isA": [
        ...
        { "@id": "http://snomed.info/sct#384821006", name: "Mental state, behavior and/or psychosocial function finding (finding)" },
        ...
        { "@id": "http://snomed.info/sct#405746006", name: "Current non smoker but past smoking history unknown (finding)" }
      ],
      ...
      "http://www.w3.org/2000/01/rdf-schema#subClassOf": [{ "@id": "http://snomed.info/sct#8392000", name: "Non-smoker (finding)" }],
      "http://endhealth.info/im#roleGroup": [
        {
          "http://endhealth.info/im#groupNumber": 1,
          "http://snomed.info/sct#363714003": [{ "@id": "http://snomed.info/sct#229819007", name: "Tobacco use and exposure (observable entity)" }]
        }
      ],
      ...
      "http://endhealth.info/im#subsumedBy": [{ "@id": "http://snomed.info/sct#160618006", name: "Current non-smoker (finding)" }]
    },
    predicates: {
...
export const hasMap = {
  entityBundle: {
    entity: {
      ...
      "http://endhealth.info/im#usuallySubsumedBy": [
        { "@id": "http://snomed.info/sct#2876009", name: "Hospital admission, type unclassified, explain by report (procedure)" },
        { "@id": "http://snomed.info/sct#55402005", name: "Hospital admission, for laboratory work-up, radiography, etc. (procedure)" },
        ...
        { "@id": "http://snomed.info/sct#397941000000102", name: "[V]Other reasons for encounter (context-dependent category)" },
        { "@id": "http://snomed.info/sct#409891000000104", name: "[V]Other reasons for encounter OS (context-dependent category)" },
        { "@id": "http://snomed.info/sct#411851000000109", name: "[X]Other boarder in health care facility (context-dependent category)" },
        { "@id": "http://snomed.info/sct#416681000000109", name: "[V]Other specified reasons for encounter (context-dependent category)" },
        { "@id": "http://snomed.info/sct#427611000000105", name: "[V]Encounter with person who has no complaint or sickness (context-dependent category)" },
        { "@id": "http://snomed.info/sct#428231000000104", name: "[V]Other boarder in health-care facility (context-dependent category)" },
        { "@id": "http://snomed.info/sct#430251000000105", name: "[V]Unspecified reasons for encounter (context-dependent category)" },
        { "@id": "http://snomed.info/sct#440431000000103", name: "[V]Person with other specified health problems (context-dependent category)" },
        { "@id": "http://snomed.info/sct#440741000000102", name: "[V]Healthy person accompanying sick person (context-dependent category)" },
        { "@id": "http://snomed.info/sct#451961000000105", name: "[V]Other reasons for encounter NOS (context-dependent category)" },
        { "@id": "http://snomed.info/sct#464391000000106", name: "[V]Unspecified health problems (context-dependent category)" }
      ],
      "http://endhealth.info/im#multipleSubsumedBy": [
        { "@id": "http://snomed.info/sct#243797000", name: "Referral and admission procedures (procedure)" },
        { "@id": "http://snomed.info/sct#11781000000101", name: "Care Programme Approach administrative procedures (procedure)" },
        { "@id": "http://snomed.info/sct#24221000000103", name: "SNOMED CT UK administrative concepts (administrative concept)" },
        {
          ...
          "http://endhealth.info/im#someOf": [
            {
              ...
              "http://endhealth.info/im#mappedTo": [
                { "@id": "http://endhealth.info/icd10#Z769", name: "Person encountering health services in unspecified circumstances" }
              ]
            },
            {
              ...
              "http://endhealth.info/im#assuranceLevel": [{ "@id": "http://endhealth.info/im#NationallyAssuredUK", name: "Nationally assured UK level" }],
              "http://endhealth.info/im#mappedTo": [{ "@id": "http://endhealth.info/icd10#Z764", name: "Other boarder in health-care facility" }]
            },
            {
              ...
              "http://endhealth.info/im#assuranceLevel": [{ "@id": "http://endhealth.info/im#NationallyAssuredUK", name: "Nationally assured UK level" }],
              "http://endhealth.info/im#mappedTo": [{ "@id": "http://endhealth.info/icd10#Z763", name: "Healthy person accompanying sick person" }]
            },
            {
              ...
              "http://endhealth.info/im#assuranceLevel": [{ "@id": "http://endhealth.info/im#NationallyAssuredUK", name: "Nationally assured UK level" }],
              "http://endhealth.info/im#mappedTo": [
                { "@id": "http://endhealth.info/icd10#Z768", name: "Persons encountering health services in other specified circumstances" }
              ]
            }
          ]
        }
      ...
      "http://endhealth.info/im#subsumedBy": [
        ...
        { "@id": "http://snomed.info/sct#431101000000109", name: "[V]Admission for instruction in the use of a nebuliser" },
        { "@id": "http://snomed.info/sct#455051000000105", name: "[V]Admitted for conversion to insulin" },
        { "@id": "http://snomed.info/sct#469761000000100", name: "[V]Admission for instruction of self-catheterisation" },
      ...
      "http://www.w3.org/2000/01/rdf-schema#subClassOf": [{ "@id": "http://snomed.info/sct#305335007", name: "Admission to establishment (procedure)" }],
    ...
    predicates: {
      ...
      "http://snomed.info/sct#11781000000101": "Care Programme Approach administrative procedures (procedure)",
      "http://endhealth.info/im#usuallySubsumedBy": "usually subsumed by",
  ...
  details: [
    ...
    },
    {
      ...
      label: "has map - http://snomed.info/sct#32485007 - SN_32485007 - 2 - 9068",
      children: [
        {
          key: "http://snomed.info/sct#2876009",
          label: "Hospital admission, type unclassified, explain by report (procedure)",
        ...
        {
          key: "11511110910132111102",
          label: "some of",
          children: [
            {
              key: "10997112112105110103329710011810599101",
              label: "mapping advice - ALWAYS Z76.9 - 4",
              children: [
                {
            ...
            {
              key: "1099711280114105111114105116121",
              label: "mapPriority - ALWAYS Z76.9 - 4",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "97115115117114971109910132108101118101108",
              label: "assurance level - ALWAYS Z76.9 - 4",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711211210110032116111",
              label: "mapped to - ALWAYS Z76.9 - 4",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "10997112112105110103329710011810599101",
              label: "mapping advice - ALWAYS Z76.4 | ADDITIONAL CODE MANDATORY | CODE MUST NEVER BE USED IN A PRIMARY POSITION - 2",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711280114105111114105116121",
              label: "mapPriority - ALWAYS Z76.4 | ADDITIONAL CODE MANDATORY | CODE MUST NEVER BE USED IN A PRIMARY POSITION - 2",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "97115115117114971109910132108101118101108",
              label: "assurance level - ALWAYS Z76.4 | ADDITIONAL CODE MANDATORY | CODE MUST NEVER BE USED IN A PRIMARY POSITION - 2",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711211210110032116111",
              label: "mapped to - ALWAYS Z76.4 | ADDITIONAL CODE MANDATORY | CODE MUST NEVER BE USED IN A PRIMARY POSITION - 2",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "10997112112105110103329710011810599101",
              label: "mapping advice - ALWAYS Z76.3 | ADDITIONAL CODE MANDATORY | CODE MUST BE USED IN A PRIMARY POSITION - 1",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711280114105111114105116121",
              label: "mapPriority - ALWAYS Z76.3 | ADDITIONAL CODE MANDATORY | CODE MUST BE USED IN A PRIMARY POSITION - 1",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "97115115117114971109910132108101118101108",
              label: "assurance level - ALWAYS Z76.3 | ADDITIONAL CODE MANDATORY | CODE MUST BE USED IN A PRIMARY POSITION - 1",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711211210110032116111",
              label: "mapped to - ALWAYS Z76.3 | ADDITIONAL CODE MANDATORY | CODE MUST BE USED IN A PRIMARY POSITION - 1",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "10997112112105110103329710011810599101",
              label: "mapping advice - ALWAYS Z76.8 - 3",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711280114105111114105116121",
              label: "mapPriority - ALWAYS Z76.8 - 3",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "97115115117114971109910132108101118101108",
              label: "assurance level - ALWAYS Z76.8 - 3",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
            ...
            {
              key: "1099711211210110032116111",
              label: "mapped to - ALWAYS Z76.8 - 3",
              children: [
                {
                  key: "http://endhealth.info/im#NationallyAssuredUK",
                  label: "Nationally assured UK level",
        ...
        {
          key: "104116116112584747119119119461195146111114103475048484847484947114100102451159910410110997351089798101108",
          label: "http://www.w3.org/2000/01/rdf-schema#label - Hospital admission - 54238014",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
              type: "link"
            }
          ]
        ...
        {
          key: "11511697116117115",
          label: "status - Hospital admission - 54238014",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "99111100101",
          label: "code - Hospital admission - 54238014",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "104116116112584747119119119461195146111114103475048484847484947114100102451159910410110997351089798101108",
          label: "http://www.w3.org/2000/01/rdf-schema#label - Hospital admission (procedure) - 763773011",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "11511697116117115",
          label: "status - Hospital admission (procedure) - 763773011",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "99111100101",
          label: "code - Hospital admission (procedure) - 763773011",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "104116116112584747119119119461195146111114103475048484847484947114100102451159910410110997351089798101108",
          label: "http://www.w3.org/2000/01/rdf-schema#label - Admission to hospital - 1227951014",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "11511697116117115",
          label: "status - Admission to hospital - 1227951014",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
        ...
        {
          key: "99111100101",
          label: "code - Admission to hospital - 1227951014",
          children: [
            {
              key: "http://endhealth.info/im#Active",
              label: "Active",
      ...
      "http://www.w3.org/ns/shacl#property": [
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#statedGender", name: "Gender as stated" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }],
          "http://www.w3.org/ns/shacl#class": [{ "@id": "http://endhealth.info/im#905011000252108", name: "Stated Gender" }]
        },
        {
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#deathIndicator", name: "death indicator" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }],
          "http://www.w3.org/ns/shacl#class": [{ "@id": "http://endhealth.info/im#VSET_Unspecified", name: "Unspecified (Data model value set)" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 4,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#ethnicity", name: "ethnicity" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }],
          "http://www.w3.org/ns/shacl#class": [{ "@id": "http://endhealth.info/im#VSET_Unspecified", name: "Unspecified (Data model value set)" }]
        },
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#forenames", name: "forenames" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#familyName", name: "family name" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#workAddress", name: "work address" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Address", name: "Address" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#temporaryAddress", name: "temporary address" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Address", name: "Address" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#patientAddress", name: "patient address history" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#PatientAddress", name: "Patient Address" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 14,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#pdsSensitive", name: "pDS sensitive" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }],
          "http://www.w3.org/ns/shacl#class": [{ "@id": "http://endhealth.info/im#VSET_Unspecified", name: "Unspecified (Data model value set)" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#relatedPersons", name: "related persons" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }],
          "http://www.w3.org/ns/shacl#class": [{ "@id": "http://endhealth.info/im#VSET_Unspecified", name: "Unspecified (Data model value set)" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#dateOfBirth", name: "date of birth" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#dateOfDeath", name: "date of Death" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#nhsNumber", name: "nHS Number" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#DemographicsGroup", name: "Demographic details" }]
        },
        {
          "http://www.w3.org/ns/shacl#datatype": [{ "@id": "http://www.w3.org/2001/XMLSchema#integer", name: "integer" }],
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#homeTelephoneNumber", name: "home telephone number" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ContactsGroup", name: "Contact details" }]
        },
        {
          "http://www.w3.org/ns/shacl#datatype": [{ "@id": "http://www.w3.org/2001/XMLSchema#string", name: "string" }],
          "http://www.w3.org/ns/shacl#order": 21,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#workTelephoneNumber", name: "work telephone number" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ContactsGroup", name: "Contact details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#mobileTelephoneNumber", name: "mobile telephone number" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ContactsGroup", name: "Contact details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#primaryEmail", name: "primary email" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ContactsGroup", name: "Contact details" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#secondaryEmail", name: "secondary email" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ContactsGroup", name: "Contact details" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 25,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#hospitalInpatientStay", name: "hospital inpatient stay" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#HospitalInpatientStay", name: "Hospital inpatient stay" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#HospitalCareGroup", name: "Hospital Care activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 26,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#medicationAuthorisation", name: "medication authorisation" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#MedicationAuthorisation", name: "Medication authorisation" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#TreatmentAndManagementGroup", name: "Treatment and management" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 27,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#gpCurrentRegistration", name: "gp current registration" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#GPCurrentRegistration", name: "GP Current registration" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#RegistrationAndCareEpisodesGroup", name: "Registration and  care episodes" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 28,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#placeOfResidenceAtEvent", name: "place of residence at event" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#PlaceOfResidenceAtEvent", name: "Place of residence at event" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#RegistrationAndCareEpisodesGroup", name: "Registration and  care episodes" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 29,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#appointment", name: "appointment" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Appointment", name: "Appointment" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#CareAdministrationGroup", name: "Care administration activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 30,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#carePlan", name: "care plan" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#CarePlan", name: "Care plan" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#TreatmentAndManagementGroup", name: "Treatment and management" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 31,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#condition", name: "condition" }],
          "http://www.w3.org/ns/shacl#maxCount": 1,
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Condition", name: "Condition" }],
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [
            { "@id": "http://endhealth.info/im#accidentAndEmergencyEncounter", name: "emergency care commissioning data set" }
          ],
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [
            { "@id": "http://endhealth.info/im#allergyIntoleranceAndAdverseReaction", name: "allergy, intolerance or adverse reaction" }
          ],
          "http://www.w3.org/ns/shacl#node": [
            { "@id": "http://endhealth.info/im#AllergyIntoleranceAndAdverseReaction", name: "Allergy, intolerance or adverse reaction" }
          ],
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#familyHistory", name: "family history" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#FamilyHistory", name: "Family history" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ClinicalGroup", name: "Clinical notes" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [
            { "@id": "http://endhealth.info/im#referralRequestOrProcedureRequest", name: "referral request or procedure request" }
          ],
          "http://www.w3.org/ns/shacl#node": [
            { "@id": "http://endhealth.info/im#ReferralRequestOrProcedureRequest", name: "Referral Request or procedure request" }
          ],
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#immunisation", name: "immunisation" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Immunisation", name: "Immunisation" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#TreatmentAndManagementGroup", name: "Treatment and management" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 37,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#hospitalOutpatientEncounter", name: "hospital outpatient encounter" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#HospitalOutpatientEncounter", name: "Hospital outpatient encounter" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#HospitalCareGroup", name: "Hospital Care activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 38,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#consultation", name: "consultation" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Consultation", name: "Consultation" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#ClinicalGroup", name: "Clinical notes" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 39,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#administrationNote", name: "administration  note" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#AdministrationNote", name: "Administration  note" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#CareAdministrationGroup", name: "Care administration activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 40,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#appointmentAttendance", name: "appointment attendance" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#AppointmentAttendance", name: "Appointment attendance" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#CareAdministrationGroup", name: "Care administration activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 41,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#criticalCareEncounter", name: "critical care encounter" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#CriticalCareEncounter", name: "Critical care encounter" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#HospitalCareGroup", name: "Hospital Care activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 42,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#prescription", name: "medication request / prescription" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#MedicationRequest", name: "Medication request / Prescription" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#TreatmentAndManagementGroup", name: "Treatment and management" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 43,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#hospitalDischarge", name: "hospital discharge" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#HospitalDischarge", name: "Hospital discharge" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#HospitalCareGroup", name: "Hospital Care activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#hospitalAdmission", name: "hospital admission" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#HospitalAdmission", name: "Hospital admission" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#HospitalCareGroup", name: "Hospital Care activities" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 48,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#procedure", name: "procedure " }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#Procedure", name: "Procedure " }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#TreatmentAndManagementGroup", name: "Treatment and management" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 49,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#diagnosticReport", name: "diagnostic report" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#DiagnosticReport", name: "Diagnostic report" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#TreatmentAndManagementGroup", name: "Treatment and management" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          "http://www.w3.org/ns/shacl#order": 50,
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#episodeOfCare", name: "episode of care" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#EpisodeOfCare", name: "Episode of care" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#RegistrationAndCareEpisodesGroup", name: "Registration and  care episodes" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [
            { "@id": "http://endhealth.info/im#gPAdminRegistrationStatus", name: "gp registration administration status history" }
          ],
          "http://www.w3.org/ns/shacl#node": [
            { "@id": "http://endhealth.info/im#GPAdminRegistrationStatus", name: "GP Registration administration status history" }
          ],
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#path": [{ "@id": "http://endhealth.info/im#gPRegistration", name: "gp registration episode" }],
          "http://www.w3.org/ns/shacl#node": [{ "@id": "http://endhealth.info/im#GPRegistration", name: "GP Registration Episode" }],
          "http://www.w3.org/ns/shacl#group": [{ "@id": "http://endhealth.info/im#RegistrationAndCareEpisodesGroup", name: "Registration and  care episodes" }],
          "http://endhealth.info/im#inversePath": [{ "@id": "http://endhealth.info/im#patient", name: "patient" }]
        }
      ],
...
export const hasParameter = {
  entityBundle: {
    entity: {
      ...
      "http://www.w3.org/2000/01/rdf-schema#subClassOf": [{ "@id": "http://endhealth.info/im#functionProperty", name: "function Property" }],
      "http://www.w3.org/ns/shacl#parameter": [
        ...
        },
        {
          ...
          "http://www.w3.org/ns/shacl#class": [
            { "@id": "http://snomed.info/sct#258700003", name: "Non-International System of Units unit of time (qualifier value)" }
          ]
        }
      ],
      "http://endhealth.info/im#function": [{ "@id": "http://endhealth.info/im#TimeDifference", name: "Time difference" }],
      "http://endhealth.info/im#scheme": [{ "@id": "http://endhealth.info/im#", name: "Endeavour code scheme and graph" }],
      "http://www.w3.org/2000/01/rdf-schema#range": [{ "@id": "http://www.w3.org/2001/XMLSchema#double", name: "double" }]
    },
    predicates: {
