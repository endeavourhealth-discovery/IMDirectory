describe("creator", () => {
  ...
  describe("data model creator", () => {
    ...
    it("can add and delete properties", () => {
      ...
      cy.getByTestId("property-builder").getByTestId("delete-property-button").first().click();
      cy.getByTestId("property-builder").find(".property").should("not.have.length");
    });
  });
});
