...
describe("ChartRescale", () => {
  describe("setTooltips", () => {
    it("returns tooltip callbacks", () => {
      ...
      expect(Object.keys(setTooltips(testCounts).callbacks)).toStrictEqual([
        "label",
      ]);
      expect(
  ...
  describe("rescaleData", () => {
    it("can rescale data", () => {
      expect(
        rescaleData([
          1030354, 93282, 1811, 1122, 99, 94, 68, 45, 26, 23, 11, 11, 8, 8, 2,
          1,
        ])
      ).toStrictEqual([
        680405.1187499999, 67617.9, 6339.178124999999, 6339.178124999999,
        6339.178124999999, 6339.178124999999, 6339.178124999999,
        6339.178124999999, 6339.178124999999, 6339.178124999999,
        6339.178124999999, 6339.178124999999, 6339.178124999999,
        6339.178124999999, 6339.178124999999, 6339.178124999999,
      ]);
