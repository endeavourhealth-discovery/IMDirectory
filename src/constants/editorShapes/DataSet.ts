...
const DatasetQueryShape: FormGenerator = {
  "@id": EDITOR.DATASET_QUERY_SHAPE,
  type: [
    {
      "@id": IM.FORM_GENERATOR
    }
  ],
  label: "Editor - Data set shape",
  comment: "Form editor for a data set",
  targetShape: {
    "@id": IM.DATASET_QUERY
  },
  property: [
    {
      ...
      property: [
        ...
        {
          label: "Property group - dataset definition builder",
          name: "Dataset definition builder",
          showTitle: true,
          order: 1,
          minCount: 1,
          maxCount: 1,
          ...
          property: [
            {
              ...
              minCount: 1,
              componentType: {
                "@id": COMPONENT.DATASET_BUILDER
              },
              validation: {
                "@id": VALIDATION.IS_DEFINITION
              },
              validationErrorMessage: "Dataset definition is not valid",
              path: {
                "@id": IM.DEFINITION
              }
            }
...
export default DatasetQueryShape;
